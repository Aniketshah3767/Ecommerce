  ...
  return (
    <form onSubmit={onSubmitHandler} className='flex flex-col w-full items-start gap-3'>
      ...
      <div className='w-full'>
        ...
        <input onChange={(e)=>setDescription(e.target.value)} value={description}  className='w-full max-w-[500px] px-3 py-2' type="textarea" placeholder='Write Prduct description' required />
      </div>

      <div className='flex flex-col cm:flex-row gap-2 w-full sm:gap-8'>
        <div>
          <p className='mb-2'>Product Category</p>
          <select onChange={(e)=> setCategory(e.target.value)} className='w-full px-3 py-2' >
            <option value="Men">Men</option>
            <option value="Woemn">Women</option>
        ...
        <div>
          ...
          <input onChange={(e) => setPrice(e.target.value)} className='w-full px-2 py-2 sm:w-[120px]' type="number" required placeholder='$$$9' />
        </div>
      </div>
